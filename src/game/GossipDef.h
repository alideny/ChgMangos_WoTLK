...
class MANGOS_DLL_SPEC GossipMenu
{
    public:
        ...
        void AddMenuItem(uint8 Icon, const std::string& Message, uint32 dtSender, uint32 dtAction, const std::string& BoxMessage, uint32 BoxMoney, uint32 BoxPoint, bool Coded = false);
        ...
        void AddMenuItem(uint8 Icon, char const* Message, uint32 dtSender, uint32 dtAction, char const* BoxMessage, uint32 BoxMoney, uint32 BoxPoint, bool Coded = false);

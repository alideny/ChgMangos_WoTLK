...
void WorldSession::HandleQuestgiverStatusQueryOpcode(WorldPacket & recv_data)
{
    ...
    DEBUG_LOG("世界: Received CMSG_QUESTGIVER_STATUS_QUERY - for %s to %s", _player->GetGuidStr().c_str(), guid.GetString().c_str());
...
void WorldSession::HandleQuestgiverHelloOpcode(WorldPacket & recv_data)
{
    ...
    DEBUG_LOG("世界: Received CMSG_QUESTGIVER_HELLO - for %s to %s", _player->GetGuidStr().c_str(), guid.GetString().c_str());

    Creature* pCreature = GetPlayer()->GetNPCIfCanInteractWith(guid, UNIT_NPC_FLAG_NONE);
    if (!pCreature)
    {
        DEBUG_LOG ("世界: HandleQuestgiverHelloOpcode - for %s to %s not found or you can't interact with him.", _player->GetGuidStr().c_str(), guid.GetString().c_str());
        return;
    }
...
void WorldSession::HandleQuestgiverAcceptQuestOpcode(WorldPacket & recv_data)
{
    ...
    DEBUG_LOG("世界: Received CMSG_QUESTGIVER_ACCEPT_QUEST - for %s to %s, quest = %u, unk1 = %u", _player->GetGuidStr().c_str(), guid.GetString().c_str(), quest, unk1 );
...
void WorldSession::HandleQuestgiverQueryQuestOpcode( WorldPacket & recv_data )
{
    ...
    DEBUG_LOG("世界: Received CMSG_QUESTGIVER_QUERY_QUEST - for %s to %s, quest = %u, unk1 = %u", _player->GetGuidStr().c_str(), guid.GetString().c_str(), quest, unk1);
...
void WorldSession::HandleQuestgiverChooseRewardOpcode(WorldPacket & recv_data)
{
    ...
    DEBUG_LOG("世界: Received CMSG_QUESTGIVER_CHOOSE_REWARD - for %s to %s, quest = %u, reward = %u", _player->GetGuidStr().c_str(), guid.GetString().c_str(), quest, reward);
...
void WorldSession::HandleQuestgiverRequestRewardOpcode( WorldPacket & recv_data )
{
    ...
    DEBUG_LOG("世界: Received CMSG_QUESTGIVER_REQUEST_REWARD - for %s to %s, quest = %u", _player->GetGuidStr().c_str(), guid.GetString().c_str(), quest);
...
void WorldSession::HandleQuestgiverCompleteQuest(WorldPacket& recv_data)
{
    ...
    // All ok, continue
    DEBUG_LOG("世界: Received CMSG_QUESTGIVER_COMPLETE_QUEST - for %s to %s, quest = %u", _player->GetGuidStr().c_str(), guid.GetString().c_str(), quest);
...
bool WorldSession::CanInteractWithQuestGiver(ObjectGuid guid, char const* descr)
{
    if (guid.IsCreatureOrVehicle())
    {
        ...
        if (!pCreature)
        {
            DEBUG_LOG("世界: %s - %s cannot interact with %s.", descr, _player->GetGuidStr().c_str(), guid.GetString().c_str());
            return false;
        }
    }
    ...
    {
        DEBUG_LOG("世界: %s - %s is dead, requested guid was %s", descr, _player->GetGuidStr().c_str(), guid.GetString().c_str());
        return false;
    }

...
enum eConfigFloatValues
{
    ...
    ///玩家伤害，治疗 倍率，生命/魔法/能量/怒气/速度倍率
    CONFIG_FLOAT_RATE_PLAYERS_A_DAMAGE,
    CONFIG_FLOAT_RATE_PLAYERS_H_DAMAGE,
    CONFIG_FLOAT_RATE_PLAYERS_A_SPELLDAMAGE,
    CONFIG_FLOAT_RATE_PLAYERS_H_SPELLDAMAGE,
    CONFIG_FLOAT_RATE_PLAYERS_A_HEAL,
    CONFIG_FLOAT_RATE_PLAYERS_H_HEAL,
    CONFIG_FLOAT_RATE_PLAYERS_A_HP,
    CONFIG_FLOAT_RATE_PLAYERS_H_HP,
    CONFIG_FLOAT_RATE_PLAYERS_A_POWER,
...
enum eConfigBoolValues
{
    ...
    // Login Broadcast
    CONFIG_BOOL_LOGIN_BROADCAST,
    // Event Announcer
    CONFIG_BOOL_EVENT_ANNOUNCER,
    // Flying Everywhere
